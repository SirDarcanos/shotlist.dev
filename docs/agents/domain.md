...
If the concept you need isn't in the glossary yet, either the language does not belong to the project or there is a real gap to record through `/domain-modeling`.
